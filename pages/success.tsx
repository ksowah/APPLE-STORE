...
const Success = ({products}: Props) => {
    ...
    const showOrderSummaryCondition = isTabletOrMobile ? showOderSummary : true
  ...
  return (
    <div>
      ...
      <main className='grid grid-cols-1 lg:grid-cols-9'>
       ...
       {mounted && (
         <section className='overflow-y-auto border-y border-l border-gray-300 bg-[#fafafa] lg:order-2 lg:col-span-4 lg:h-screen lg:border-t-0'>
         <div className={`${showOrderSummaryCondition && "border-b"} border-gray-300 text-sm lg:hidden`}>
             <div className='mx-auto flex max-w-xl items-center justify-between px-4 py-6'>
                 <button onClick={() => setShowOderSummary(!showOderSummary)} className="flex items-center space-x-2">
